          ...
          <div class="text-white text-center">
            ...
            <div class="mt-2">
              <input
                ...
                placeholder="E-mail"
              />
              <div class="btn-primary-tail bg-blue-600 mt-4" @click="sendResetEmail()">
                Enviar
              </div>
            </div>
          </div>
...
export default {
  ...
  setup() {
    ...
    const { email, reset, sendResetEmail } = useResetPassword;

    return { linkWhatsApp, email, reset, sendResetEmail };
  },
};
</script>
